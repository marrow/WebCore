...
* *Rapid web _application_ development.* The web has grown to be more complicated than simple HTML pages and forms. YAPWF includes alternate dialects for things like XML-RPC and Flash AMF to help you develop powerful applications.
