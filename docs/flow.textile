...
# @_prepare = [BaseExtension.prepare, TemplateExtension.prepare, SessionExtension.prepare, DatabaseExtension.prepare]@
# @_before = [DatabaseExtension.before]@
# @_after = [DatabaseExtension.after, SessionExtension.after]@
